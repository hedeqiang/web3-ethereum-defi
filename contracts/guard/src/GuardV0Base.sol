...
abstract contract GuardV0Base is IGuard, Multicall {
    ...
    // ----- Protocol: Velora -----
    // State is managed by VeloraLib via diamond storage.
    // No storage variables needed here — the library uses a deterministic
    ...
    function _validateCallInternal(
        ...
        // any action through the guard without restriction. This is by
        // design so that governance-voted transactions can rescue funds
        // from stuck contracts, fix misconfigured whitelists, or handle
